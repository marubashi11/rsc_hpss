...
O_feature = pickle.load(open(os.path.join(model_dir, "O~-test_feature.txt"), "rb"))
H_feature = pickle.load(open(os.path.join(model_dir, "H~-test_feature.txt"), "rb"))
P_feature = pickle.load(open(os.path.join(model_dir, "P-test_feature.txt"), "rb"))
feature_stack = np.column_stack((O_feature, H_feature, P_feature))
...
y_pred_ = clf.predict(feature_stack)
